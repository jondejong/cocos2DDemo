...
- (void) setupExample
{
    ...
    //A weird little experiment (diving board type thing)
...
- (void) setupMergedShapes
{
    ...
    NSArray *array = [smgr getShapesOnBody:sh1->body];    
    NSAssert([array count] == 4, @"There should be 4 shapes on this body (count: %d)", [array count]);
...
-(void) reset
{
    ...
    [[CCDirector sharedDirector] replaceScene:[CCTransitionFade transitionWithDuration:.4 scene:scene  withColor:ccWHITE]];
}
